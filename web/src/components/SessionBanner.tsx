...
export default function SessionBanner() {
  ...
  return (
    <div className="flex flex-wrap items-center gap-3 rounded-lg bg-ql-surface-container/60 border border-ql-outline-variant px-4 py-2.5 text-xs">
      <span className="text-ql-on-surface-variant uppercase tracking-widest font-bold text-[9px]">
        Session
      </span>
      <span className="font-mono font-bold text-ql-on-surface">
        {objectiveLabel(session.objective)}
      </span>
      <span className="text-ql-on-surface-variant">|</span>
